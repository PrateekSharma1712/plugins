package io.flutter.plugins.trail;
...
import io.flutter.plugins.trail.contract.AnimationCallback;

/**
 * Created by amal.chandran on 15/11/17.
 */

public class AnimationRouteHelper implements io.flutter.plugins.trail.contract.Animator {
  ...
  public void init() {
    ...
    firstTimeRouteAnimator.addListener(new Animator.AnimatorListener() {
      @Override
      public void onAnimationStart(Animator animator) { isFirstTimeDrawing = true;
      }
      @Override
